...
import { utf8Encode, utf8Decode } from './muxframe.js';
...
function structuredCloneSafe(o) {
  ...
  if (o && typeof o === 'object') { const r = {}; for (const k of Object.keys(o)) r[k] = structuredCloneSafe(o[k]); return r; }
  return o;
}
...
export function deflate(obj, bytesPaths) {
...
export function inflate(json, segs, bytesPaths) {
